...
LPCWSTR this_proc_txt = L"proc2_txt.txt";
LPCWSTR this_proc_bmp = L"proc2_bmp.bmp";
LPCWSTR other_proc_txt = L"proc1_txt.txt";
LPCWSTR other_proc_bmp = L"proc1_bmp.bmp";
