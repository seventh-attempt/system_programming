// lab02_proc2.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "lab02_proc2.h"
#include "string"
...
LPCWSTR this_txt_mapping_name = L"txt2_mapping_name";
LPCWSTR this_bmp_mapping_name = L"bmp2_mapping_name";
LPCWSTR other_txt_mapping_name = L"txt1_mapping_name";
LPCWSTR other_bmp_mapping_name = L"bmp1_mapping_name";

wchar_t this_proc_txt[] = L"D:\\study\\system_programming\\lab02\\lab02_proc2\\proc2_txt.txt";
wchar_t this_proc_bmp[] = L"D:\\study\\system_programming\\lab02\\lab02_proc2\\proc2_bmp.bmp";
wchar_t other_proc_txt[] = L"D:\\study\\system_programming\\lab02\\lab02_proc1\\proc1_txt.txt";
wchar_t other_proc_bmp[] = L"D:\\study\\system_programming\\lab02\\lab02_proc1\\proc1_bmp.bmp";
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_LAB02PROC2, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB02PROC2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAB02PROC2));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LAB02PROC2);
...
BOOL InitializationAllFile() {
	...
	string mesage2 = "Txt file proc 2\r\n";

	WriteFile(hFileTxt, mesage2.c_str(), mesage2.length(), 0, NULL);
